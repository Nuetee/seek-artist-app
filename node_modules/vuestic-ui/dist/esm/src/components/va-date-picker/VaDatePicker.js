...
const _sfc_main = defineComponent({
  ...
  props: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, useStatefulProps), extractComponentProps(VaDatePickerHeader)), extractComponentProps(VaDayPicker)), extractComponentProps(VaMonthPicker)), extractComponentProps(VaYearPicker)), {
