import { defineComponent, resolveComponent, openBlock, createElementBlock, createElementVNode, toDisplayString, createVNode, withCtx, createTextVNode } from "vue";
...
const _hoisted_1 = { class: "va-file-upload-single-item" };
const _hoisted_2 = { class: "va-file-upload-single-item__name" };
const _hoisted_3 = /* @__PURE__ */ createTextVNode(" Delete ");
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_va_button = resolveComponent("va-button");
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createElementVNode("div", _hoisted_2, toDisplayString(_ctx.file && _ctx.file.name), 1),
