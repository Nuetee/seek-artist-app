...
import { defineComponent, shallowRef, ref, toRefs, computed, watch, nextTick, resolveComponent, openBlock, createElementBlock, createVNode, normalizeClass, normalizeStyle, withCtx, renderSlot, normalizeProps, guardReactiveProps, mergeProps, withKeys, withModifiers, createSlots, createElementVNode, toHandlers, createBlock, createCommentVNode, renderList } from "vue";
...
import "../../composables/usePopover.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createVNode(_component_va_dropdown, {
      ...
      anchor: withCtx(() => [
        renderSlot(_ctx.$slots, "input", normalizeProps(guardReactiveProps({ inputAttributes: _ctx.inputAttributesComputed, inputWrapperProps: _ctx.inputWrapperProps, inputListeners: _ctx.inputListeners })), () => [
          createVNode(_component_va_input_wrapper, mergeProps(_ctx.inputWrapperProps, {
            onClick: _ctx.toggleDropdown,
            onKeydown: [
              withKeys(withModifiers(_ctx.toggleDropdown, ["stop"]), ["enter"]),
          ...
          ]), 1040, ["onClick", "onKeydown"])
        ])
      ]),
      default: withCtx(() => [
        createVNode(_component_va_dropdown_content, {
          onKeydown: withKeys(withModifiers(_ctx.hideAndFocus, ["prevent"]), ["esc"])
        }, {
          default: withCtx(() => [
