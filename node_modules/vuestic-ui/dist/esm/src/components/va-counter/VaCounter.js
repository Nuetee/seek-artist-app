...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_VaInputWrapper, mergeProps({ class: "va-counter" }, __spreadValues(__spreadValues({}, _ctx.fieldListeners), _ctx.inputWrapperPropsComputed), {
