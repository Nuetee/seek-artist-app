...
import { defineComponent, shallowRef, computed, nextTick, resolveComponent, openBlock, createBlock, normalizeClass, normalizeStyle, withCtx, createVNode, mergeProps, withKeys, withModifiers, createSlots, createElementVNode, toHandlers, renderSlot, normalizeProps, guardReactiveProps, createCommentVNode, renderList } from "vue";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_va_dropdown, {
    ...
    anchor: withCtx(() => [
      createVNode(_component_va_input_wrapper, mergeProps(_ctx.computedInputWrapperProps, {
