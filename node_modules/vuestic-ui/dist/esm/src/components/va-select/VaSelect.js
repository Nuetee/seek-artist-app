...
import { defineComponent, shallowRef, computed, ref, watch, nextTick, resolveComponent, openBlock, createBlock, withKeys, withModifiers, withCtx, createVNode, createSlots, mergeProps, createCommentVNode, renderSlot, createElementBlock, toDisplayString, normalizeProps, createTextVNode, normalizeStyle, createElementVNode } from "vue";
import "../../../vendor.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_va_dropdown, {
    ...
    _: 3
  }, 8, ["aria-label", "placement", "disabled", "max-height", "fixed", "close-on-content-click", "modelValue", "onKeydown", "onClick"]);
}
